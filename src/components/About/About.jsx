...
const cards = [
  {
    ...
    description:
      "To deliver innovative, reliable, and precision-engineered biosafety solutions that empower scientific progress and ensure the highest standards of safety and performance.",
  },
  {
    id: 2,
    img: card2,
    ...
    description:
      "To be the global leader in biosafety technology, setting new benchmarks for safety, efficiency, and innovation while supporting advancements in science and healthcare.",
  },
  {
    id: 3,
    img: card3,
    ...
    description:
      "We understand the high-stakes nature of your work, which is why we focus on more than just delivering equipment. We deliver peace of mind. AirBio is your partner in achieving breakthroughs, ensuring your team’s safety, and adhering to the highest industry standards.",
  },
];
        ...
        <div className="p-5">
          <div className=" text-center md:max-w-[85%] mx-auto">
            ...
            <p className="mt-1 text-[#7A7A7A]">
              Driving innovation and excellence to craft products that transform
              ideas into reality.
            </p>
            <img src={about} alt="" className="my-8 lg:w-full h-auto" />
            <p className="text-justify px-2">
              At AirBio, we don’t just manufacture biosafety solutions; we craft
              an ecosystem of trust, performance, and reliability. Since our
              inception, AirBio has been driven by a singular mission—to empower
              laboratories worldwide with cutting-edge equipment that combines
              scientific precision with robust safety measures. Whether you're
              safeguarding research or enhancing operational efficiency, AirBio
              ensures you’re equipped with the best.
            </p>
            <p className="text-justify px-2 mt-5">
              The AirBio Journey In just six years, AirBio has transformed from
              a bold idea into a trusted partner for laboratories across the
              globe. Inspired by the vision to redefine MedTech equipment, our
              team of scientists, engineers, and innovators continually pushes
              boundaries, delivering solutions that meet international
              standards. From biosafety cabinets to laminar flow hoods and fume
              hoods, every AirBio product is a testament to our relentless
          ...
          <div className="md:max-w-[80%] mx-auto flex flex-col md:flex-row flex-wrap justify-center items-center gap-10 my-8 ">
            <div className=" flex flex-col justify-center items-center mx-5">
              ...
              <div className=" md:h-[100px]">
                ...
                <p className="w-[150px] text-center text-[#1E1E1E] tracking-wider">
                  Equipment Quality
                </p>
              </div>
            </div>
            ...
            <div className=" flex flex-col justify-center items-center mx-5">
              ...
              <div className=" h-[100px]">
                ...
                <p className="text-center text-[#1E1E1E] tracking-wider">
          ...
          <div className="md:max-w-[85%] mx-auto">
            <div className="lg:flex">
              ...
              <div className="lg:w-[50%] lg:flex flex-col justify-center items-end">
                <div className="lg:w-[408px]">
                  <h1 className="text-2xl md:text-3xl text-center lg:text-start my-5">
                    Mission
                  </h1>
                  <p className="text-[#404040] text-justify mb-5">
                    To deliver innovative, reliable, and precision-engineered
                    biosafety solutions that empower scientific progress and
            ...
            <div className="lg:flex lg:my-10">
              ...
              <div className="lg:w-[50%] lg:flex lg:order-1 flex-col justify-center">
                ...
                <p className="text-[#404040] lg:w-[408px] text-justify mb-5">
                  To be the global leader in biosafety technology, setting new
                  benchmarks for safety, efficiency, and innovation while
                  supporting advancements in science and healthcare.
                </p>
              </div>
            </div>
                    ...
                    <ul className="text-[#404040]">
                      <li className="flex items-start">
                        <p>
                          ...
                          Driving excellence through cutting-edge technology.
                        </p>
                      </li>
                      <li className="flex items-start">
                        <p>
                          ...
                          Ensuring uncompromising protection for people and
                          processes.
                        </p>
                      </li>
                      <li className="flex items-start">
                      ...
                      <li className="flex items-start">
                        <p>
                          ...
                          Creating eco-friendly solutions for a better future.
                        </p>
                      </li>
                      <li className="flex items-start">
                        <p>
                          ...
                          Partnering with clients to advance scientific
                          discovery.
                        </p>
                      </li>
                    </ul>
          ...
          <div className="my-10 pt-5">
            <div className="text-center md:text-start md:max-w-[85%] mx-auto md:flex justify-between items-center pt-5 border-blue-600">
              ...
              <p className="text-[15px] py-2 md:py-0 md:w-[283px] text-[#7A7A7A]">
                Driving innovation and excellence to craft products that
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 md:max-w-[85%] h-auto my-10 mx-auto gap-4">
              {TeamData.map((card) => (
                ...
                >
                  ...
                  <div className="relative w-full aspect-[4/4.2] bg-gray-100">
                    {" "}
                  ...
                  <div className="pt-3 pb-4 bg-[#f8f8f8]">
                    ...
                    <p className="mt-1 text-center text-[#1782C5]">
                      {card.role}
                    </p>
                  </div>
                </div>
