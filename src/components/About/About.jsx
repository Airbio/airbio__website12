...
const About = () => {
  return (
    <div>
      ...
      <div className='p-5'>
        <div className='p-5 text-center md:max-w-[85%] mx-auto'>
          <h1 className='text-[#1782C5] text-3xl font-semibold'>Get to Know Us</h1>
        ...
        <div className='md:max-w-[80%] mx-auto flex flex-col md:flex-row justify-center items-center gap-10 my-8'>
            ...
            {cards.map((card) => (
              ...
              >
                <img
                  src={card.img}
                  alt={card.name}
                  className="w-auto h-[297px] md:w-full object-cover rounded"
                />
            ...
            {TeamData.map((card) => (
              ...
              >
                ...
                <div className="pt-2 bg-[#f8f8f8] rounded-b-lg">
                  <h3 className="text-lg text-center font-semibold">{card.name}</h3>
