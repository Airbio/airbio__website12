...
import img1 from "../../assets/images/laminar/laf.webp";
import art1 from "../../assets/images/laminar/Vertical Laminar AirFlow/Vertical Laminar Airflow-FRONT.webp";
import art2 from "../../assets/images/laminar/Vertical Laminar Flow (Velocity)/Velocity VLF img1.jpeg";
...
const features = [
  ...
  },
  {
    ...
    description: "Enhancing air purity.",
  },
  {
    icon: icon7,
    title: "10° Angled Safety Glass",
    description: "Ergonomic visibility and comfort. ",
  },
  {
    icon: icon8,
...
const cardsData = [
  {
    ...
    description:
      "Laminar air flow cabinets provide a sterile, HEPA-filtered workspace",
    buttonText: "Visit Product",
    path: "/product/laminar/Airflow",
  },
  {
    title: "Velocity",
    image: art2,
    subtitle: "Vertical Laminar AirFlow",
    description:
      "Safeguard samples but aren’t suitable for hazardous substances",
    buttonText: "Visit Product",
    showTitle: true,
        ...
        <div className="">
            ...
            <div>
              <div className="gap-3 p-5 flex flex-col my-5 items-center">
                ...
                <p className=" text-sm text-[#1E1E1E] text-center">
                  AirBio Laminar Cabinets deliver unmatched reliability and
          ...
          <div className="my-10 p-5 md:my-16 md:py-5">
            <h1 className="text-2xl font-medium text-center my-5 pb-5">
              Key Features of{" "}
              <span className="text-[#1782C5]">Laminar Air Flow Cabinets</span>
            </h1>
            ...
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  Laminar air flow cabinets, also known as laminar clean
                  benches, flow hoods, or air flow benches, create a controlled
                  sterile environment to safeguard samples and products from
                  contaminants like microorganisms and airborne particles. These
                  cabinets operate by drawing air through a high-efficiency HEPA
                  filter and channeling it in a consistent, streamlined airflow
                  towards the user – the hallmark of "laminar flow."
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="my-10 p-5">
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  A trusted solution in laboratories worldwide, the Velocity
                  vertical laminar air flow cabinet combines advanced technology
                  with user-friendly features to elevate safety and efficiency.
                  Available in multiple sizes, it boasts a modern touch-screen
