...
import art4 from "../../assets/images/biosafety/bsc class 2 A2 (Agies)/BSC CLASS II A2 (Agies)-FRONT.png";
...
const cardsData = [
  {
    ...
    description:
      "A benchtop model with a 100% exhaust system for volatile chemicals and radionuclides.",
  ...
  },
  {
    ...
    description:
      "It ensures reliable containment with a dynamic air barrier and robust engineering control.",
    buttonText: "Visit Product",
    showTitle: true,
  ...
  },
  {
    ...
    description:
      "A compact, energy-efficient tabletop model ideal for labs and academia.",
    buttonText: "Visit Product",
  ...
  // },
  {
    ...
    description:
      "Its durable stainless steel design simplifies cleaning and offers flexible airflow options for safety.",
    buttonText: "Visit Product",
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "Explore AirBio Biosafety Cabinets including Class II A2, Class II B2 and advanced biosafety solutions for laboratories and research facilities.",
            url: "https://www.airbio.in/product/Biosafety",
          })}
        </script>
      </Helmet>
      <div>
        ...
        <div className="">
          <div className="p-5 md:w-[80%] mx-auto md:flex justify-between items-center">
            <div>
              <h1 className="text-3xl md:text-5xl font-medium text-center md:text-start my-3 md:mb-8 text-[#1782C5] leading-10 md:leading-tight md:w-[250px]">
                Airbio Biosafety Cabinets
              </h1>
              ...
              <div className="pl-5 md:pl-10 flex justify-center">
                <div className="flex overflow-x-scroll scrollbar scrollbar-thumb-customBlue scrollbar-track-gray-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full pr-5 gap-4 md:gap-10 py-4 mx-auto">
                  {cardsData.map((card, index) => (
                    <div key={index}>
                      {/* Card Content */}
                      <div className="min-w-[318px] h-[368px] md:w-[300px] md:h-[370px] flex flex-col justify-center items-center md:min-w-0 rounded-3xl p-4 border border-[#CDCDCD]">
                        {card.showTitle && (
          ...
          <div className="my-10 p-5 md:my-16 md:py-5">
            <h1 className="text-2xl font-medium text-center my-5 pb-5">
              Key Features of{" "}
              <span className="text-[#1782C5]">AirBio Bio Safety Cabinets</span>
            </h1>
              ...
              <div className="md:w-[60%] md:mr-8 ">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  <span className="font-medium">
                    AirBio Biosafety Cabinets (BSCs)
                  </span>{" "}
                  are precision-engineered laboratory workspaces designed for
                  the safe handling of potentially hazardous or contaminated
                  materials. By combining unidirectional airflow from the top
                  with air inflow from the surrounding room, these cabinets
                  create a dynamic air barrier that protects both users and
                  their materials from contamination. <br />
                  They are available in two variants -{" "}
                  <span className="font-medium">Class II A2</span>and{" "}
                  <span className="font-medium">Class II B2</span>.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#F8F8F8] md:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              <div className="md:w-[40%]">
                <img
                  src={post2}
                  alt=""
                  className="w-[300px] h-auto  md:h-[300px] md:w-auto object-cover"
                />
              </div>
              ...
              <div className="md:w-[60%] md:mr-8 ">
                <h1 className="text-xl text-center md:text-start md:text-3xl font-medium mb-5">
                  Tailored to Meet{" "}
                  <span className="text-[#1782C5]">Biosafety</span> Needs
                </h1>

                <p className="text-justify text-[14px] text-opacity-75">
                  Biosafety Cabinets come in various classes, each catering to
                  specific bio-containment requirements. Within these classes,
                  the cabinets differ based on how air is recirculated or
                  exhausted. Regardless of the type, all AirBio BSCs leverage{" "}
                  <span className="font-medium">
                  ...
                  filters to maintain a sterile workspace.
                </p>
              </div>
            </div>
          </div>
