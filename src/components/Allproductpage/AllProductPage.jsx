            ...
            <div className='p-5'>
                ...
                <div>
                    <div>
                        ...
                        <div>
                            <div className="flex overflow-x-scroll scrollbar scrollbar-thumb-customBlue scrollbar-track-gray-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full gap-4 md:gap-10 py-4 md:w-[90%] mx-auto">
                ...
                {/* features */}
                <div className="my-10 md:my-16 md:py-5">
                ...
                <div className='my-10'>
                    <div className='bg-[#F8F8F8] md:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg'>
                        ...
                        <div className='md:w-[60%] md:mr-8 '>
                            <h1 className='text-xl md:text-3xl font-medium mb-5'>About <span className='text-[#1782C5]'>AirBio Biosafety Cabinets</span> </h1>
                ...
                <div className='my-10'>
                    <div className='bg-[#F8F8F8] md:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg'>
                        ...
                        <div className='md:w-[60%] md:mr-8 '>
                            <h1 className='text-xl md:text-3xl font-medium mb-5'>Tailored to Meet <span className='text-[#1782C5]'>Biosafety</span> Needs</h1>
