            ...
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  ...
                  environment for handling hazardous chemicals and materials,
                  ensuring the safety of both the user and the laboratory. By
                  effectively capturing and containing fumes, vapors, and
                  particulates, these hoods minimize exposure to potentially
                  dangerous substances. AirBio fume hoods utilize advanced
                  airflow systems to draw contaminated air through a robust
                  filtration mechanism, channeling clean, filtered air back into
                  the workspace or expelling it safely outside.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  ...
                  hood blends state-of-the-art technology with ergonomic design
                  to ensure optimal safety and performance. Available in various
                  configurations, it offers a versatile and user-centric
