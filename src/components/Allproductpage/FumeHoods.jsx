...
const features = [
  ...
  },
  {
    ...
    description: "Reduces turbulence and enhances user protection.",
  },
  {
    icon: icon3,
    title: "Digital Touch Interface",
    description: "Accurate airflow monitoring and intuitive control.",
  },
  {
    icon: icon4,
    title: "Built-in Alarm System",
    description: " Alert users to airflow inconsistencies or filter changes.",
  },
  {
    icon: icon5,
  ...
  },
  {
    ...
    description: "recirculating or ducted installations.",
  },
  {
    icon: icon7,
  ...
  },
  {
    ...
    description: "Designed for ease of use and operator comfort.",
  },
  // {
  //     icon: icon10,
  //     title: "Energy Efficient Design",
...
const cardsData = [
  {
    ...
    description:
      "Designs to meet the specific needs of different laboratory and industrial applications",
    buttonText: "Visit Product",
    path: '/product/FumeHoods/FumeHood',
  },
];
      ...
      <div className="">
        <div className="p-5 md:w-[80%] mx-auto flex flex-col lg:flex-row justify-between items-center ">
          ...
          <div>
            <img
              src={img1}
              alt=""
              className="md:h-[380px] md:w-auto object-cover"
            />
          </div>
        </div>
          ...
          <div>
            <div className="gap-3 p-5 flex flex-col my-5 items-center">
              ...
              <p className=" text-sm text-[#1E1E1E] text-center">
                AirBio Fume Hoods deliver unmatched reliability and protection
        ...
        <div className="my-10 p-5 md:my-16 md:py-5">
          <h1 className="text-2xl font-medium text-center my-5 pb-5">
            Key Features of{" "}
            <span className="text-[#1782C5]">AirBio Fume Hoods</span>
          </h1>
          ...
          <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
            ...
            <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
              ...
              <p className="text-justify text-[14px] text-opacity-75">
                AirBio fume hoods are engineered to provide a secure environment
                for handling hazardous chemicals and materials, ensuring the
                safety of both the user and the laboratory. By effectively
                capturing and containing fumes, vapors, and particulates, these
                hoods minimize exposure to potentially dangerous substances.
                AirBio fume hoods utilize advanced airflow systems to draw
                contaminated air through a robust filtration mechanism,
                channeling clean, filtered air back into the workspace or
        ...
        <div className="my-10 p-5">
          <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
            ...
            <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8 ">
              <h1 className="text-xl text-center md:text-start md:text-3xl font-medium mb-5">
                Tailored to Meet{" "}
                <span className="text-[#1782C5]">Fume Hoods</span> Needs
              </h1>

              <p className="text-justify text-[14px] text-opacity-75">
                A trusted choice for laboratories worldwide, the Velocity fume
                hood blends state-of-the-art technology with ergonomic design to
                ensure optimal safety and performance. Available in various
                configurations, it offers a versatile and user-centric solution
                for diverse laboratory needs.
              </p>
            </div>
          </div>
        </div>
