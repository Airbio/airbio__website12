...
const features = [
    {
        ...
        description: "Advanced germicidal UV lamp for effective contamination control.",
    },
    {
        icon: icon2,
    ...
    },
    {
        ...
        description:
            "Energy-efficient and quiet performance for laboratories.",
    },
    // {
    //     icon: icon7,
        ...
        <div>
            ...
            <div className=''>
                <div className='p-5 md:w-[80%] mx-auto flex flex-col lg:flex-row justify-between items-center '>
                    <div className='mb-5'>
                        <h1 className='text-3xl md:text-5xl font-medium text-center lg:text-start my-3 md:mb-8 text-[#1782C5] leading-10 md:leading-tight lg:w-[250px]'>PCR Workstations</h1>
                        <div className='flex items-center justify-center gap-3 md:gap-5'>
                            ...
                            <p className='border border-black p-1 px-4 text-sm md:text-lg rounded-3xl'>Safety</p>
                        </div>
                    </div>
                    <div className=''>
                    ...
                    <div>
                        <div className="gap-3 p-5 flex flex-col my-5 items-center">
                            ...
                            <p className=" text-sm text-[#1E1E1E] text-center">
                                AirBio PCR Workstations deliver reliable contamination control for accurate molecular biology workflows.
                            </p>
                        </div>
                ...
                <div className="my-10 p-5 md:my-16 md:py-5">
                    <h1 className="text-2xl font-medium text-center my-5 pb-5">
                        Key Features of <span className="text-[#1782C5]">PCR Workstations</span>
                    </h1>
                ...
                <div className='my-10 p-5'>
                    <div className='bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg'>
                        ...
                        <div className='md:w-[60%] md:px-5 lg:px-0 lg:mr-8 '>
                            <h1 className='text-xl text-center md:text-start md:text-3xl font-medium mb-5'>About <span className='text-[#1782C5]'>PCR Workstations</span> </h1>
                            <p className='text-justify text-[14px] text-opacity-75'>PCR Workstations are specially designed clean working enclosures used for contamination-free PCR preparation and molecular biology applications. Equipped with UV decontamination technology and optional HEPA-filtered vertical airflow, these workstations help maintain sterile working conditions and improve the accuracy of sensitive DNA/RNA procedures. Their ergonomic and compact design makes them ideal for modern research and diagnostic laboratories."
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className='my-10 p-5'>
                    <div className='bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg'>
                        ...
                        <div className='md:w-[60%] md:px-5 lg:px-0 lg:mr-8 '>
                            <h1 className='text-xl text-center md:text-start md:text-3xl font-medium mb-5'>Meet AirBio’s <span className='text-[#1782C5]'>GeneSafe PCR Workstation</span></h1>
                            <p className='text-justify text-[14px] text-opacity-75'>
                               AirBio’s GeneSafe PCR Workstation is engineered for high-performance molecular workflows and contamination-sensitive applications. Built with advanced safety features, UV protection, and efficient airflow technology, it delivers dependable performance for PCR setup, RT-PCR procedures, genomics research, and molecular diagnostics. Designed for laboratories that demand precision, safety, and reliability.
                               </p>
                        </div>
                    </div>
                </div>
