...
const features = [
  {
    ...
    description:
      "99.99% efficient filtration removes particles up to 0.3 microns.",
  },
  {
    icon: icon2,
    title: "Interlocking Doors",
    description:
      "Prevents simultaneous opening to maintain cleanroom integrity.",
  },
  {
    icon: icon3,
...
const cardsData = [
  {
    ...
    description:
      "High-velocity HEPA filtered air shower for personnel decontamination",
        ...
        <div className="">
          ...
          <div>
            <div className="gap-3 p-5 flex flex-col my-5 items-center">
              ...
              <p className="text-sm text-[#1E1E1E] text-center">
                AirBio Air Showers provide high-velocity HEPA filtered air to
                effectively remove contaminants from personnel before entering
                cleanroom areas.
              </p>
            </div>
          ...
          <div className="my-10 p-5 md:my-16 md:py-5">
            <h1 className="text-2xl font-medium text-center my-5 pb-5">
              Key Features of{" "}
              <span className="text-[#1782C5]">Air Showers</span>
            </h1>
            ...
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  Air Showers are essential personnel decontamination systems
                  used in cleanrooms. They use high-velocity HEPA filtered air
                  to remove dust, particles, and contaminants from personnel
          ...
          <div className="my-10 p-5">
            <div className="bg-[#F8F8F8] lg:w-[80%] mx-auto p-5 px-6 flex flex-col md:flex-row items-center gap-5 rounded-lg">
              ...
              <div className="md:w-[60%] md:px-5 lg:px-0 lg:mr-8">
                ...
                <p className="text-justify text-[14px] text-opacity-75">
                  AirBio Air Showers are engineered with advanced HEPA
                  filtration, interlocking doors, and intelligent control
                  systems for stringent contamination control in pharmaceutical,
                  biotechnology, electronics, and other high-tech industries.
                </p>
              </div>
            </div>
          </div>
