    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              AirBio specializes in the design, manufacturing, and supply of
              high-performance laboratory and cleanroom equipment including:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "HVAC and Controlled Environment Solutions",
              ].map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
            <p className="mt-2">
              Our products are engineered to deliver high standards of safety,
              efficiency, reliability, and performance for laboratories,
              healthcare facilities, pharmaceutical industries, research
              centers, and cleanroom environments.
            </p>
            <p className="mt-2">
              We also provide installation, validation, AMC, maintenance, and
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              Some standard products may be available for immediate dispatch,
              while customized or project-based equipment may require
              manufacturing time. Delivery timelines depend on:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Product type",
    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              Yes. We understand that every laboratory and cleanroom project has
              unique requirements. Our technical team works closely with
              customers to provide customized solutions based on:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Laboratory size and layout",
            ...
            <p className="mt-2">
              Customized dimensions, materials, configurations, and
              project-specific solutions can also be developed for industries
              such as Life Sciences, Pharmaceuticals, Healthcare, Research, and
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              AirBio products are designed using advanced air filtration and
              containment technologies. Key features may include:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "Integration support for modern laboratory systems",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              Yes. Our technical team can guide customers in selecting suitable
              equipment based on:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
    ...
    questions: [
      {
        ...
        a: (
          <>
            ...
            <p className="mt-2">
              Final pricing is shared through an official quotation.
            </p>
          </>
        ),
      },
          ...
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "UPI payments (India)",
                "Approved business payment methods",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
            <p className="mt-2">
              Payment options may vary depending on order value and customer
              location.
            </p>
          </>
        ),
    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              Installation charges depend on the product type, project scope,
              and customer location.
            </p>
            <p className="mt-2 font-medium text-[#1E1E1E]">
              Installation Policy:
            </p>
            <ul className="list-disc pl-5 mt-1 space-y-1 text-[#1E1E1EBF]">
              <li>
                Basic installation for selected standard products within certain
                locations may be free.
              </li>
              <li>
                Large equipment, cleanroom projects, HVAC systems, and
                customized installations are usually chargeable.
              </li>
              <li>International installations are chargeable.</li>
            </ul>
            <p className="mt-2 font-medium text-[#1E1E1E]">
              Installation charges may include:
            </p>
            <ul className="list-disc pl-5 mt-1 space-y-1 text-[#1E1E1EBF]">
              {[
                "Engineer visit charges",
                "Travel expenses",
            ...
            <p className="mt-2">
              Final installation cost will be mentioned in the official
              quotation.
            </p>
          </>
        ),
      },
      {
        ...
        a: (
          <>
            <p>
              Yes. Installation support for international customers can be
              arranged. Customers may need to bear:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Visa expenses",
                ...
                "Accommodation",
                "Local transportation",
                "Applicable government taxes and permits",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              Yes. For selected products, remote installation assistance may be
              provided through:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
            ...
            <p className="mt-2">
              Remote guidance availability depends on the product category.
            </p>
          </>
        ),
      },
    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              Yes. We support worldwide shipping for selected products and
              projects. Shipping methods may include:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Air freight",
            ...
            <p className="mt-2">
              Shipping availability depends on destination country regulations.
            </p>
          </>
        ),
      },
      {
        ...
        a: (
          <>
            <p>
              Shipping charges are generally separate unless specifically
              mentioned in the quotation. Shipping costs depend on:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Destination",
      ...
      },
      {
        ...
        a: (
          <>
            ...
            <p className="mt-2">
              Customers are advised to check local import regulations before
              placing orders.
            </p>
          </>
        ),
      },
      {
        ...
        a: (
          <>
            ...
            <p className="mt-2">
              Estimated delivery timelines will be shared during order
              confirmation.
            </p>
          </>
        ),
    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              Yes. AirBio products undergo quality testing and are designed to
              comply with applicable industry safety and operational standards.
              Our systems are developed to support:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Laboratory safety requirements",
                "Cleanroom operational standards",
                "Reliable airflow and filtration performance",
            ...
            <p className="mt-2">
              Specific certifications and compliance details can be shared based
              on product category and project requirements.
            </p>
          </>
        ),
      },
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              To ensure proper safety and performance, biosafety cabinets should
              generally be inspected, certified, and serviced at least once
              every year.
            </p>
          ...
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "Mishandling during transportation after delivery",
      ...
      },
      {
        ...
        a: (
          <>
            ...
            <p className="mt-2">
              Our team works to ensure systems continue performing efficiently
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              Onsite service may be free within the warranty scope for eligible
              cases. However, the following may be chargeable:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Out-of-warranty service visits",
                "Replacement parts",
                "Travel expenses",
                "Emergency visits",
                "AMC-related services outside agreement scope",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
            <p className="mt-2">
              Charges depend on location and service requirements.
            </p>
          </>
        ),
      },
      {
        ...
        a: (
          <>
            <p>
              Yes. AMC and preventive maintenance services are available for
              selected products and projects. AMC plans may include:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Routine inspection",
            ...
            <p className="mt-2">
              AMC pricing depends on equipment type and service frequency.
            </p>
          </>
        ),
      },
          ...
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "Submitting inquiry forms on the website",
                "Approving official quotations",
                "Sending purchase orders through email",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
          ...
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "Inform AirBio within 48 hours",
                "Share shipment and invoice details",
              ].map((i) => (
                <li key={i}>{i}</li>
              ))}
            </ul>
            <p className="mt-2">
              The support team will assist further based on the case.
            </p>
          </>
        ),
      },
      ...
      },
      {
        ...
        a: (
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Official website inquiry forms",
                "Email support",
                "Phone support",
    ...
    questions: [
      {
        ...
        a: (
          <>
            ...
            <p className="mt-2">
              Documentation availability depends on product category and
              destination country.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        a: (
          <>
            <p>
              Yes. International customers can receive online support through:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                "Email",
    ...
    questions: [
      {
        ...
        a: (
          <>
            <p>
              Yes. AirBio can provide complete turnkey cleanroom solutions
              including:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
          ...
          <>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1 text-[#1E1E1EBF]">
              {[
                ...
                "Sending product requirements through email",
            ...
            <p className="mt-2">
              Please include detailed specifications for accurate pricing and
              recommendations.
            </p>
          </>
        ),
...
const AccordionItem = ({ question, answer, isOpen, onToggle }) => {
  return (
    <div
      className={`border rounded-xl mb-3 overflow-hidden transition-all duration-300 ${isOpen ? "border-[#1782C5]" : "border-[#C3C3C3]"}`}
    >
      <button
      ...
      >
        <span
          className={`font-medium text-sm md:text-base pr-4 ${isOpen ? "text-[#1782C5]" : "text-[#1E1E1E]"}`}
        >
          {question}
        </span>
        <span
          className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center transition-colors duration-200 ${isOpen ? "bg-[#1782C5]" : "bg-[#F0F0F0]"}`}
        >
          <svg
            width="14"
            height="14"
...
const FAQ = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          AirBio FAQs - Answers About Biosafety Cabinets and Laboratory Solutions
        </title>
        <meta
          name="description"
          content="Find answers to frequently asked questions about Biosafety Cabinet, Class II Biosafety Cabinet, Class II BSC, Laminar Flow Cabinet, Laminar Air Flow Chamber and AirBio laboratory safety solutions."
        />
        <link rel="canonical" href="https://www.airbio.in/faq" />
      </Helmet>
      <div>
        <Header />
        ...
        <div className="p-5 py-10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-2 md:text-base text-[#1E1E1EBF]">
              Welcome to the AirBio FAQ section. Find answers to commonly asked
              questions about our products, ordering, shipping, installation,
            ...
            <p className="mt-1 text-sm md:text-base text-[#1E1E1EBF]">
              ...
              <a
                href="/contact"
                className="text-[#1782C5] font-medium hover:underline"
              >
          ...
          <div className="md:w-[85%] mx-auto">
            ...
            <div className="mt-10 border border-[#1782C5] rounded-xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-4 bg-[#F5FAFF]">
              <div>
                <h2 className="font-medium text-lg md:text-xl text-[#1E1E1E]">
