...
const comparisonData = [
    ...
    { feature: 'Cost Efficiency', geneSafe: 'High Advantage', international: 'Premium Cost' },
    { feature: 'Service Support in India', geneSafe: 'Easily Available', international: 'Limited/Costly in Some Regions' },
]
    ...
    return (
        <div>
            ...
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Meet AirBio's GeneSafe PCR Workstation</h1>
                <p className='my-5 md:px-2 text-justify'>A reliable and advanced contamination-control workstation designed for molecular biology applications, the GeneSafe PCR Workstation combines UV decontamination technology with HEPA-filtered airflow and an ergonomic bench-top configuration — delivering reproducible and contamination-free PCR preparation for modern laboratories.</p>
            </div>

            {/* Key Features */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Key Features of GeneSafe PCR Workstation</h1>
                <div className='md:px-2'>
                    {[
                        { bold: 'UV Decontamination System', text: 'with germicidal UV lamp for effective surface and air decontamination.' },
                        { bold: 'Optional HEPA-Filtered Vertical Laminar Airflow', text: 'providing a clean, particle-free working environment.' },
                        { bold: 'SS 304 Stainless Steel Internal Chamber', text: 'for durability and easy decontamination.' },
                        { bold: 'Microprocessor-Based Digital Control System', text: 'for precise and reliable operation.' },
                        { bold: 'UV-Resistant Front Sash with Safety Interlock', text: 'ensuring user protection during UV operation.' },
                        { bold: 'Low-Noise, Energy-Efficient Operation', text: 'suitable for quiet laboratory environments.' },
                        { bold: 'Compact Ergonomic Bench-Top Configuration', text: 'designed for minimal footprint and maximum convenience.' },
                        { bold: 'Easy-Clean Contamination-Resistant Interior Surfaces', text: 'for hassle-free maintenance.' },
                    ].map((item, i) => (
            ...
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Performance Advantages</h1>
                <div className='md:px-2'>
                    {[
            ...
            {/* Applications */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Applications</h1>
                <div className='md:px-2'>
                    {[
            ...
            {/* Safety Features */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Safety Features</h1>
                <div className='md:px-2'>
                    {[
            ...
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Standard Accessories</h1>
                <div className='md:px-2'>
                    {[
                        'UV germicidal lamp.',
            ...
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Compliance & Certification</h1>
                <div className='md:px-2'>
                    {[
            ...
            {/* Warranty & Support */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Warranty & Support</h1>
                <div className='md:px-2'>
                    {[
                        { bold: '12 Months Comprehensive Warranty', text: 'on all components.' },
                        { bold: 'Installation and Operational Training Support', text: 'provided at setup.' },
                        { bold: 'After-Sales Technical Service Support', text: 'available pan India.' },
                    ].map((item, i) => (
                        <div key={i} className='flex items-start gap-3 mt-5'>
                            <img src={rightArrow} alt="Right Arrow" className="w-4 h-4 mt-1" />
                            <p><b>{item.bold}</b> {item.text}</p>
            ...
            {/* Recommended For */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Recommended For</h1>
                <div className='md:px-2'>
                    {[
            ...
            {/* Comparison Table */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>GeneSafe vs Leading International Brands</h1>
                <div className='md:px-2 mt-5 overflow-x-auto'>
                    <table className='w-full border-collapse text-sm'>
                        <thead>
                            <tr className='bg-[#1782C5] text-white'>
                                ...
                                <th className='text-left p-3 font-medium rounded-tr-lg'>Leading International Brands</th>
                            </tr>
                        </thead>
                        <tbody>
