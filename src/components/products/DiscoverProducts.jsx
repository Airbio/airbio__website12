...
import art1 from "../../assets/images/biosafety/bsc class 2 A2/BSC falcon class II A2 img4.jpeg";
...
const cardData = [
  {
    ...
    image: art1,
    description:
      "Ensure contaminant free, precision tasks in research, healthcare and manufacturing",
  ...
  },
  {
    ...
    image: art2,
    description:
      "Safe, efficient and eco-friendly protection from hazardous fumes and pollutants",
  ...
  },
  {
    ...
    image: art3,
    description:
      "Create a secure environment to handle biological samples with maximum safety and compliance",
  ...
  },
  {
    ...
    image: art5,
    description:
      "Pass Boxes ensure safe and contamination-free material transfer between cleanroom areas.",
      ...
      <div>
        ...
        <div className="my-10">
          <div className=" md:flex justify-between px-5 pb-5 md:px-10 md:p-5 my-5 border-blue-600">
            <h1 className="text-3xl font-[500px] text-center md:w-[500px] md:text-[40px] ">
          ...
          <div className="flex overflow-x-scroll md:overflow-x-hidden md:grid md:grid-cols-3 gap-4 md:gap-10 p-4 mx-auto max-w-screen-lg scrollbar scrollbar-thumb-customBlue scrollbar-track-gray-200 scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
            {cardData.map((card, index) => (
              ...
              >
                ...
                />
                <p className="mb-4 text-center text-[#1782C5]">
                  {card.description}
                </p>
                <Link to={card.Route}>
