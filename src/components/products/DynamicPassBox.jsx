...
const DynamicPassBoxData = [
  {
    ...
    title3: "Reliable",
    description1:
      "The AirBio Dynamic Pass Box is a state-of-the-art solution engineered to facilitate the smooth and contamination-free transfer of materials between two classified and non-classified areas. It plays a critical role in upholding integrity, cleanliness, and regulatory compliance of cleanrooms.",
    description2:
      "Equipped with HEPA filtration, advanced interlock system, and microprocessor-based controls, it ensures safe material transfer while minimizing downtime and maintaining strict GMP & regulatory standards.",
    img1: product1,
    img2: product2,
    // img3: product3,
  },
...
const technicalSpecs = [
  ...
  {
    parameter: "Door Type",
    specification: "Double Door with Electromagnetic / Mechanical Interlock",
  },
  { parameter: "Filtration", specification: "HEPA Filter 99.99% @ 0.3 µm" },
  {
    parameter: "Airflow",
    specification: "Two Stage Filtration with Recirculation",
  },
  ...
  { parameter: "Power Supply", specification: "220–240 V AC, 50 Hz" },
  {
    ...
    specification: "Door Interlock, Alarm, Pressure Gauge",
  },
...
const keyFeatures = [
  {
    bold: "Robust Construction",
    text: "Strong and durable build for long-lasting performance.",
  },
  {
    bold: "HEPA Filtration",
    text: "High-efficiency filtration for clean and sterile environment.",
  },
  {
    bold: "Advanced Interlock System",
    text: "Prevents simultaneous door opening with alarm.",
  },
  {
    bold: "Easy Material Transfer",
    text: "Two-way control system with visual and audio indicators.",
  },
  {
    bold: "Enhanced Safety Measures",
    text: "UV light, pressure monitoring, and cycle time control.",
  },
  {
    bold: "Quick Maintenance",
    text: "Easy access panels for filter replacement.",
  },
  {
      ...
      <div>
            ...
            >
              ...
              <div className="md:w-[60%]">
                ...
                <div className="mb-4 flex flex-col md:flex-row justify-center md:justify-start md:items-start md:flex-wrap items-center gap-5 mt-8">
                  <a
                    href="https://dashboard.skydo.com/pay/pyl_ReBWUW"
                    target="_blank"
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          ...
          <p className="my-5 md:px-2 text-justify">
            AirBio Dynamic Pass Box is designed for high-performance material
            transfer in controlled environments. With two-stage HEPA filtration
            and intelligent interlock system, it ensures zero
            cross-contamination while maintaining cleanroom integrity.
          </p>
        </div>
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          <h1 className="text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium">
            AirBio Dynamic Pass Box vs International Brands
          </h1>
          <div className="md:px-2 mt-5 overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <thead>
              ...
              <tbody>
                {[
                  {
                    feature: "HEPA Filtration",
                    airbio: "Yes (Two Stage)",
                    international: "Yes",
                  },
                  {
                    feature: "Interlock System",
                    airbio: "Advanced with Alarm",
                    international: "Yes",
                  },
                  {
                    feature: "HMI Control",
