                ...
                {productData.map((product, index) => (
                    ...
                    >
                        <div className="mb-4 text-center md:hidden">
                                <h2 className=" text-[#1782C5] m-2 mb-3 py-2 px-4 md:m-0 border border-[#1782C5] inline-block font-medium rounded-full">
                                    {product.name}
                                </h2>
                                <h3 className="text-2xl md:text-3xl text-[#1E1E1E]">{product.title}</h3>
                            </div>
                        {/* 1st Div: Images */}
                        ...
                        <div className="md:w-[60%] ">
                            ...
                            <div className="hidden md:block mb-4 text-center md:text-start">
                                <h2 className=" text-[#1782C5] m-2 py-2 px-4 md:m-0 border border-[#1782C5] inline-block rounded-full font-medium">
                                    {product.name}
                                </h2>
                                <h3 className="md:text-3xl text-[#1E1E1E] pt-4">{product.title}</h3>
                            </div>
