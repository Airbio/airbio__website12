...
const technicalSpecs = [
    ...
    { parameter: 'Construction Material', specification: 'Powder-coated CRCA steel / SS 304' },
    ...
    { parameter: 'Configuration', specification: 'Single Leaf / Double Leaf Door' },
]

const keyFeatures = [
    { bold: 'High-Efficiency HEPA Filtration', text: '99.99% efficiency down to 0.3 microns.' },
    { bold: 'Interlocking Doors', text: 'Prevents simultaneous opening to maintain contamination control.' },
    { bold: 'High Velocity Airflow', text: 'Powerful air jets remove particles from clothes and skin.' },
    { bold: 'Customizable Configurations', text: 'Available in single/double door and various sizes.' },
    { bold: 'Easy Maintenance', text: 'Accessible panels for quick filter replacement.' },
        ...
        <div>
            ...
            <div className="p-6">
                {AirShowerData.map((product, index) => (
                    <div key={index} className="relative md:w-[90%] mx-auto md:flex justify-between items-center md:gap-8 pt-2 rounded-lg border-[#1782C5]">
                        {/* Mobile Title */}
                        ...
                        <div className="flex flex-col md:flex-row justify-center items-center border-[#1782C5] mb-5">
                            <div className="w-[90%] md:w-full flex justify-center items-center">
                                <img src={selectedImage} alt="Selected Product" className="w-full h-[335px] p-4 px-4 lg:w-[423px] lg:h-[458px] object-contain rounded-lg mb-5 md:m-0 border border-[#1782C5]" />
                            </div>
                            <div className="h-auto pl-2 mb-5 flex md:flex-col justify-between items-center gap-5">
                                {[product.img1, product.img2,].map((img, i) => (
                                    <img key={i} src={img} alt={`Product ${i+1}`}
                                        ...
                                        className={`w-[75px] h-[75px] md:w-[107px] md:h-[107px] bg-[#F7F7F7] object-contain p-1 rounded-lg cursor-pointer ${selectedImage === img ? "border-[#1782C5] border" : ""}`} />
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="md:w-[60%]">
                            <div className="hidden md:block mb-4 text-center md:text-start">
                                <h2 className="m-2 py-2 px-4 md:m-0 border border-black inline-block rounded-full font-medium">{product.name}</h2>
                            ...
                            <div className="mb-4 flex flex-col md:flex-row gap-5 mt-8">
                                ...
                                <a href="https://api.whatsapp.com/send?phone=9899829299" target="_blank" rel="noopener noreferrer">
                                    <button className="bg-[#1E1E1E] text-white w-[193px] px-4 py-2 rounded-full hover:bg-[#1782C5]">Get a Quote</button>
                                </a>
                                <div className='px-4 py-2 flex items-center gap-4 rounded-full border border-[#7A7A7A] hover:text-[#1782C5] hover:border-[#1782C5]'>
                                    <a href="https://api.whatsapp.com/send?phone=9899829299" target="_blank" rel="noopener noreferrer">
                                        <button className='flex items-center gap-2'><img src={whatsapp} alt="" /> Speak With Expert</button>
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div className='p-6 md:w-[90%] mx-auto'>
                ...
                <p className='my-5 md:px-2 text-justify'>
                    AirBio Air Shower acts as a barrier to keep the cleanroom extremely clean by removing contaminants from personnel through high-velocity HEPA filtered air before they enter the controlled area.
                </p>
            </div>
            ...
            {/* Working Principle */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Working Principle</h1>
                <div className='md:px-2 mt-4 text-justify'>
                    <p>The Air Shower has doors opening on sides. When a person enters and the cycle starts, high-velocity HEPA filtered air blows from nozzles removing contaminants from clothes and skin. After the cycle completes, the person can exit from the other side.</p>
                </div>
            </div>

            {/* Size Chart / Models */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Size Chart for Air Shower</h1>
                <div className='md:px-2 mt-5 overflow-x-auto'>
                    <table className='w-full border-collapse text-sm'>
                        <thead>
                            <tr className='bg-[#1782C5] text-white'>
                        ...
                        <tbody>
                            <tr className='bg-[#F5F5F5]'><td className='p-3'>Type I</td><td className='p-3'>1-2</td><td className='p-3'>1200×1000×2050 mm</td><td className='p-3'>AS-SLD-121 2SS</td></tr>
                            <tr><td className='p-3'>Type II</td><td className='p-3'>2-4</td><td className='p-3'>1500×2000×2050 mm</td><td className='p-3'>AS-SLD-152 2SS</td></tr>
                            <tr className='bg-[#F5F5F5]'><td className='p-3'>Type III</td><td className='p-3'>2-5</td><td className='p-3'>2330×2000×2050 mm</td><td className='p-3'>AS-SLD-232 2SS</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            {/* Accessories */}
            <div className='p-6 md:w-[90%] mx-auto'>
                <h1 className='text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium'>Accessories</h1>
                <div className='md:px-2 mt-5 overflow-x-auto'>
                    <table className='w-full border-collapse text-sm'>
                        <thead>
                            <tr className='bg-[#1782C5] text-white'>
                        ...
                        <tbody>
                            {[
                                { acc: 'Vertical/Horizontal Door', desc: 'Various door configurations' },
                                { acc: 'Buzzers', desc: 'Audible alarms for safety' },
                                { acc: 'HMI+PLC Control System', desc: 'Touchscreen interface for easy operation' },
                            ].map((item, i) => (
                                <tr key={i} className={i % 2 === 0 ? 'bg-[#F5F5F5]' : 'bg-white'}>
