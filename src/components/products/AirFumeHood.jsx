...
const AirFumeData = [
  {
    ...
    title3: "Performance",
    description1:
      "AirBio Fume Hoods provide tailored solutions to meet the safety and operational requirements of diverse laboratory environments. Whether handling volatile chemicals, ensuring air quality, or maintaining safety for specialized substances, there’s an ideal fume hood for every application.",
    description2:
      "Ideal for laboratories requiring superior containment, AirBio fume hoods adhere to stringent safety standards, making them indispensable for chemical handling, pharmaceutical research, and academic applications.",
    img1: product1,
    img2: product2,
    img3: product3,
    img4: product2,
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            name: "Air Fume Hood",
            description:
              "Laboratory fume hood designed for chemical handling, containment and operator protection.",
            brand: {
              "@type": "Brand",
              name: "AirBio",
            },
      ...
      <div>
          ...
          {AirFumeData.map((product, index) => (
            ...
            >
              ...
              <div className="md:w-[60%] ">
                ...
                <div className="mb-4 flex flex-wrap justify-center items-center md:justify-start gap-3 text-center md:text-start">
                ...
                <div className="mb-4 flex flex-col md:flex-row justify-center md:justify-start md:items-start md:flex-wrap items-center gap-5 mt-8 ">
                  <div className="flex justify-between gap-2">
                    <a
                      href=" https://dashboard.skydo.com/pay/pyl_Xt61i8"
                      target="_blank"
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          <h1 className="text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium">
            Meet AirBio’s Fume Hood
          </h1>
          <p className="my-5 md:px-2 text-justify">
            A trusted choice for laboratories worldwide, the Velocity fume hood
            blends state-of-the-art technology with ergonomic design to ensure
            optimal safety and performance. Available in various configurations,
            it offers a versatile and user-centric solution for diverse
            laboratory needs.
          </p>
        </div>
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          ...
          <div className="md:px-2">
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Advanced Filtration System</b> with options for carbon or
                HEPA filters to ensure precise air purification.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              <img
              ...
              />
              <p>
                <b>Aerodynamic Sash Design</b> that reduces turbulence and
            ...
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Digital Touch Interface</b> for accurate airflow monitoring
            ...
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Built-in Alarm System</b> to alert users to airflow
                inconsistencies or filter changes.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              <img
              ...
              />
              <p>
                <b>Durable Work Surface</b> constructed from chemical-resistant
                materials for extended longevity.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              <img
              ...
              />
              <p>
                <b>Customizable Exhaust Options</b> for recirculating or ducted
                installations.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Energy-Efficient LED Lighting</b> that provides excellent
                visibility with minimal energy consumption.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              <img
              ...
              />
              <p>
                <b>Ergonomic Sash Handles</b> designed for ease of use and
                operator comfort.
              </p>
            </div>
          </div>
