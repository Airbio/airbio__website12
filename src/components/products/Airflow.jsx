...
const AirFlowData = [
  {
    ...
    title3: "Efficiency",
    description1:
      'Laminar air flow cabinets, also known as laminar clean benches, flow hoods, or air flow benches, create a controlled sterile environment to safeguard samples and products from contaminants like microorganisms and airborne particles. These cabinets operate by drawing air through a high-efficiency HEPA filter and channeling it in a consistent, streamlined airflow towards the user – the hallmark of "laminar flow."',
    description2:
      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "HEPA-filtered laminar airflow cabinet providing a sterile and contamination-free workspace.",
            brand: {
              "@type": "Brand",
              name: "AirBio",
            },
      ...
      <div>
              ...
              <div className="md:w-[60%] ">
                ...
                <div className="mb-4 flex flex-col md:flex-row justify-center md:justify-start md:items-start md:flex-wrap items-center gap-5 mt-8 ">
                  <div className="flex justify-between gap-2">
                    <a
                      href="https://dashboard.skydo.com/pay/pyl_wDjA7e"
                      target="_blank"
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          <h1 className="text-center md:text-start text-xl md:text-2xl text-[#1782C5] p-1 px-2 py-3 rounded-lg bg-[#F5F5F5] font-medium">
            Meet AirBio’s Velocity Laminar Air Flow Cabinet
          </h1>
          <p className="my-5 md:px-2 text-justify">
            A trusted solution in laboratories worldwide, the Velocity vertical
            laminar air flow cabinet combines advanced technology with
            user-friendly features to elevate safety and efficiency. Available
            in multiple sizes, it boasts a modern touch-screen interface for
            seamless operation.
          </p>
        </div>
        ...
        <div className="p-6 md:w-[90%] mx-auto">
          ...
          <div className="md:px-2">
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Hinged Front Panel</b> with self-support brackets for
            ...
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Intuitive Touch Interface</b> for precise control and
                monitoring.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Dual Rear Cable Managers</b> to keep your workspace tidy and
                organized.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Stainless Steel Work Surface</b>, offering durability and
                easy cleaning.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Front-Loading HEPA Filter</b> for superior filtration and
            ...
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Trace Odor Pre-Filter</b>, enhancing air purity.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              <img
              ...
              />
              <p>
                <b>10° Angled Safety Glass</b> for ergonomic visibility and
                comfort.
              </p>
            </div>
            <div className="flex items-start gap-3  mt-5">
              ...
              />
              <p>
                <b>Glass Side Walls</b>, providing enhanced illumination and
