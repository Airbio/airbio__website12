        ...
        <div className="p-5 py-10 ">
          ...
          <div className=" border-black md:w-[80%] mx-auto md:flex justify-center my-8">
            <div className="md:order-2">
              <img
                src={contact3}
                alt=""
                className="w-full h-[245px] md:w-[540px] md:h-[300px] object-cover rounded-t-lg md:rounded-l-none md:rounded-r-lg"
              />
            </div>
            <div className="bg-[#1782C5] md:order-1 md:w-[45%] md:flex items-center p-5 px-8 gap-5 text-white rounded-b-lg md:rounded-b-none md:rounded-l-lg ">
              <div className="">
                <img
                  src={icon}
                  alt=""
                  className="w-12 h-12  justify-start items-center p-2 rounded-lg  border "
                />
                <h1 className="font-medium text-xl md:text-2xl mt-5 mb-3">
                  Schedule a Meeting
                  <br /> with our Experts
                </h1>
                <p className="text-[#D9D9D9] text-sm my-3">
                  Book a session with our experts to get <br /> personalized
                ...
                >
                  <button className="bg-white flex justify-between items-center gap-1 hover:bg-[#1782C5] w-auto h-[38px] p-2 px-3 rounded-full hover:border hover:border-white transition-colors duration-200 group">
                    <span className="text-black transition-colors duration-200 group-hover:text-white">
                      Schedule Meeting
                    </span>

                    <div className="flex items-center justify-center w-[28px] h-[28px] rounded-full group ">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
          ...
          <div className="flex flex-col gap-8 md:flex-row md:gap-8 md:w-[80%] mx-auto my-10 ">
            ...
            <div className="border flex flex-col gap-4 p-5 px-7 w-[90%] mx-auto font-custom rounded-lg border-[#1782C5]">
              ...
              <div>
                <p className="text-[#1E1E1E] text-opacity-75">
                  Connect with our Social Handles Stay Updated with Latest News!
                </p>
            ...
            <div className="border flex flex-col gap-4 p-5 pb-7 px-7 w-[90%] mx-auto font-custom rounded-lg border-[#1782C5]">
              ...
              <div>
                <p className="text-[#1E1E1E] text-opacity-75 mb-6">
                  12/42, Pioneer Compound, Site IV, Sahibabad Industrial Area,
                  Ghaziabad- 201010, Uttar Pradesh.
                </p>
                <div className="flex justify-center items-center">
                  <a
                    href="https://maps.app.goo.gl/TgVT5d8wzAxkSZVb9"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className=" bg-black text-white  p-1 px-3 rounded-3xl">
                      Locate on Maps
                    </button>
                  </a>
                </div>
