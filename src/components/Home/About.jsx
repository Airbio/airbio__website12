            ...
            <div className='p-5 md:mt-12 flex flex-col md:flex justify-center items-center border-red-600'>
                ...
                <div className='md:flex justify-between w-full max-w-7xl md:px-5 items-center border-black'>
                    <div className='my-5 md:w-[50%]'>
                        <img src={banner} className='w-[370px] md:w-[520px] h-auto md:h-auto rounded-xl' alt="" />
                    </div>
...
<div className="max-w-screen-xl mx-auto px-4 pb-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="w-full max-w-[350px] mx-auto h-[530px] md:h-[500px] flex flex-col justify-center items-center rounded-3xl p-4 border border-[#CDCDCD]">
            ...
            <img src={art1} alt="Biosafety Cabinets" className="w-full h-[369px] md:w-[280px] object-contain mb-2 rounded-xl" />
