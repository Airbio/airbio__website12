...
const Team = () => {
  ...
  return (
    <>
      ...
      <div className="py-8 px-4 mb-10 border">
        <Swiper
          ...
          {TeamData.map((member) => (
            <SwiperSlide key={member.id}>
              <div className="bg-white relative shadow-md rounded-lg mb-8 md:mb-0 p-2 md:py-4 flex flex-col items-center text-center border border-[#CDCDCD]">
                ...
                {/* Name and Role */}
                <div className="absolute top-full translate-y-[-50%] min-w-[90%] md:mb-5 bg-white flex flex-col items-center rounded-lg border border-black">
                  <div className="text-lg text-[12px] px-2">{member.name}</div>
